...
public class InformationFragment extends Fragment {
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnInformationFragmentInteractionListener) {
            mListener = (OnInformationFragmentInteractionListener) context;
        } else {
    ...
    public interface OnInformationFragmentInteractionListener {
        ...
        void onInformationFragmentInteraction();
    }
}
